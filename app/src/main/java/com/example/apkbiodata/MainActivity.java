...
public class MainActivity extends AppCompatActivity {
    ...
    public void openMaps(View v){
        Uri coord = Uri.parse("geo:-6.9921697, 110.3942171?q=-6.9921697, 110.3942171(Mentari Kost)");
    ...
    public void openContact(View v){
        ...
        intent.setData(Uri.parse("tel:08534458610"));
    ...
    public void openEmail(View v){
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, "111202113694@mhs.dinus.ac.id");
